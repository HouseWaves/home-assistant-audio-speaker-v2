...
- A DIY guide to adding an inexpensive, off-the-shelf ESP32-based controller with integrated DAC, DSP and AMP inside an existing speaker cabinet and flash with open source firmware (Squeezelite, SendSpin, ESPHome).<br/>
...
Prices shown are approximate USD and include shipping, taxes and customs fees. (note - this repo was updated. The original post said $50/speaker and did not account for these additional costs)
...
| 2    | [Sonocotta LOUD ESP32 - Sold by Elecrow](https://tidd.ly/4tGxNQD) <br/><br/>or<br/><br/> [Sonocotta LOUD ESP32 - Sold by Lectronz](https://lectronz.com/products/loud-esp32) | 1          | $25          | ESP32 with integrated DAC & AMP; <br />no Ethernet module; <br/>optional $5 RPi case to protect the circuit board<br/>**buy two if modifying both speakers.** <br/> <br/>Elecrow based in China but delivers to US with much lower shipping & customs fees <br/><br/>Lectronz based in EU (updated May 5, 2026; Tindie is no longer in business.<br/> <br/> no current US-based reseller, but I will sell in a kit (see bottom row) |
| 3    | [USB-C Panel Mount Cable](https://www.amazon.com/dp/B09HWSFRP1) | 1          | $12          | **buy two if modifying both speakers.**                      |
| 4    | Optional back plate                                          | 1          | $2           | If you have access to a 3D printer, print the 1.5" square plate (STL file included).  Otherwise, you can drill a small hole for the cable.<br/> **print two if modifying both speakers.** |
| OR   | [NEW Build Kit - Contains ESP32 Board + USB-C Cable + Optional Back Plate](https://housewaves.myshopify.com/products/parts-kit-for-v2-60-diy-wifi-bt-audio-speaker-for-home-assistant)<br /><br />Does not include the speaker itself | 1          | $44+shipping | Many people have asked for a US-based seller for the Sonocotta boards; quite a few people indicated they would prefer to buy in a "kit" form.<br />To assist those of you who are asking for this, I will offer to bundle these parts and ship them to you (in the US). <br />Full disclosure - after deducting credit card transaction fees and my cost for these parts, I am earning $14  for my time in putting these packages together in a shipping box, printing labels and taking them to the post office. |
